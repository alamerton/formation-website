              ...
              content: (
                <>
                  ...
                  <p className="mt-4">
                    ...
                    influence, a sphere of interest, and a set of assumptions
                    and evidence. This theory of change is subject to change on
              ...
              content: (
                <>
                  <p>
                    ...
                    team. The research team will conduct scientific and
                    technical research in accordance with the research agenda.
                  </p>
              ...
              content: (
                <>
                  <p>
                    ...
                    be called the products of the organisation. The research
                  ...
                  <p className="text-sm">
                    ...
                    provides a framework for creating reliable knowledge with
                    high epistemic validity.
                  </p>
                  <h3 className="text-lg font-semibold mt-4 mb-2">
                  ...
                  <p className="text-sm">
                    ...
                    scientific research papers – they will take existing
                    knowledge and the knowledge created by the research to
                    create recommendations to key decision-makers in the field.
                  </p>
                </>
              ),
            },
            {
              ...
              content: (
                <>
                  ...
                  <p className="text-sm">
                    The goal of the organisation is to minimise lock-in risks
                    from AI systems. The organisation is operating on the
                    assumption that lock-in risks would develop as a consequence
                    of the behaviour and usage of AI systems.
                  </p>
                </>
              ),
            },
              ...
              content: (
                <>
                  <p className="text-sm">
                    ...
                    change rests, the evidence for each assumption, and
                    associated confidence levels and their explanations.
                  </p>
                  {[
                    {
                      assumption:
