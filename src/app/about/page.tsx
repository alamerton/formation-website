          ...
          <CardContent>
            <div>
              <p>
                ...
                values: first-principles, bottom-up, collaborative, scientific
                and technical research into the behaviours of AI systems and the
              ...
              <p>
                ...
                rationality, we believe that thinking about lock-in risks from
                first principles is the best way to keep unhelpful biases from
                clouding our research. This is not the same as only using the
                knowledge we create, that is not realistic. It means forming our
                own conceptual and theoretical models of the world based on our
                understanding of the laws of physics and computation, and
                testing the assumptions borrowed from other fields before
                employing them.
              </p>
              ...
              <p>
                ...
                simple facts about AI systems and game theory, rather than
                resting on the conceptual models of other fields or
              ...
              <p>
                ...
                economic research who may approach lock-in from a different
                point of view.
              </p>
              ...
              <p>
                We plan to use the scientific method in our research with the
                goal of creating fundamental knowledge about lock-in risks. We
                plan to use:
              </p>
              ...
              <p>
                ...
                that can solve problems. We want to use the existing and created
